...
class Assignment(db.Model):
    ...
    def mark_grade(cls, _id, grade, auth_principal: AuthPrincipal):
        ...
        if auth_principal.teacher_id is not None:
            assertions.assert_valid(assignment.teacher_id == auth_principal.teacher_id,'This assigement submitted to some other teacher')
        if auth_principal.principal_id is not None:
            assertions.assert_valid(assignment.state != AssignmentStateEnum.DRAFT,'Principle cannot grade a draft assignment')    
